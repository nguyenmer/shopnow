  ...
  return (
    <Container>
      ...
      <Container>
        <Row>
          ...
          <Col md={4} className="mb-3">
            ...
            <ul className="list-unstyled">
              <li>
                <a href="https://secitc.vn/" className="text-dark text-decoration-none">Home</a>
              </li>
              <li>
          ...
          <Col md={4} className="mb-3">
            ...
            <div className="d-flex gap-3">
              <a href="https://www.facebook.com/groups/secitc.vn" target="_blank" rel="noopener noreferrer" className="text-dark">
                <Facebook />
              </a>
              <a href="https://www.youtube.com/@secitcvn" target="_blank" rel="noopener noreferrer" className="text-dark">
                <YouTube />
              </a>
            </div>
          </Col>
        ...
        <p className="text-center mb-0">&copy; {new Date().getFullYear()} Shop now - Microservice - secitc.vn. All rights reserved.</p>
      </Container>
    </footer>
    </Container>
  );
